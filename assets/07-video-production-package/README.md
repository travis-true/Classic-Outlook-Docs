# Asset 7 — Six-video production package
...
python3 "$REPO/build/build_asset_07_video_package.py"
...
find "$REPO/build/output/supplemental-assets/07-video-production-package" -maxdepth 3 -type f -print

open "$REPO/build/output/supplemental-assets/07-video-production-package"
```
