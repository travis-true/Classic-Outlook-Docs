# Asset 6 — Classic Outlook keyboard shortcuts
...
python3 "$REPO/build/build_asset_06_keyboard_shortcuts.py"
...
find "$REPO/build/output/supplemental-assets/06-keyboard-shortcuts" -maxdepth 3 -type f -print

open "$REPO/build/output/supplemental-assets/06-keyboard-shortcuts"
```
